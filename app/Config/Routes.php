...
$routes->get('erp/document-view/(:segment)', 'Documents::document_view', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/documents/update_official_document', 'Documents::update_official_document', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
...
$routes->get('erp/estimates-products-list/', 'Estimates::product_estimates', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/estimates-category/', 'Estimates::product_estimates_category', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/estimates-brand/', 'Estimates::product_estimates_brand', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/create-new-estimate/', 'Estimates::create_estimate', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/fetch-model-codes-by-brand/(:segment)', 'Estimates::fetchBrandsModelCode/$1', ['namespace' => 'App\Controllers\Erp', 'filter' => 'checklogin']);
// $routes->get('erp/fetch-model-codes-by-brand/(:segment)', 'Estimates::fetchBrandsModelCode/$1', ['namespace' => 'App\Controllers\Erp', 'filter' => 'checklogin']);
...
$routes->get('erp/estimate-detail/approve-estimate/(:segment)', 'Estimates::estimate_approve', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
...
$routes->get('erp/estimate-view/(:segment)', 'Estimates::estimate_view', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/estimate-product-view/(:segment)', 'Estimates::estimate_product_view', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/estimate-product-details/(:segment)', 'Estimates::getProductDetails', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
...
$routes->get('import-excel', 'ExcelImportController::import');
$routes->post('/import', 'ExcelImportController::import');
