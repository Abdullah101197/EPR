...
<ul class="pc-navbar">
  ...
  <?php } ?>
  <?php if(in_array('estimate_product',staff_role_resource())) {?> 
  <!-- Estimates -->
  <li class="pc-item"><a href="<?= site_url('erp/estimates-products-list');?>" class="pc-link "><span class="pc-micon"><i data-feather="calendar"></i></span><span class="pc-mtext">
    Estimate Product
    </span></a></li>
  <?php } ?>
  <?php if(in_array('estimate_category',staff_role_resource())) {?> 
  <!-- Estimates -->
  <li class="pc-item"><a href="<?= site_url('erp/estimates-category');?>" class="pc-link "><span class="pc-micon"><i data-feather="calendar"></i></span><span class="pc-mtext">
    Estimate Category
    </span></a></li>
  <?php } ?>
  <?php if(in_array('estimate_brand',staff_role_resource())) {?> 
  <!-- Estimates -->
  <li class="pc-item"><a href="<?= site_url('erp/estimates-brand');?>" class="pc-link "><span class="pc-micon"><i data-feather="calendar"></i></span><span class="pc-mtext">
    Estimate Brand
    </span></a></li>
  <?php } ?>
