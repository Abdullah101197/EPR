...
<?php if($router->methodName() =='create_invoice' || $router->methodName() =='edit_invoice'){?>
    <script type="text/javascript">
	$(document).ready(function(){
		...
		$('#select2-projectSelect-results').css('display', 'none');
		$('#projectSelect').select2('close');
	...
	CKEDITOR.replace('bankDetailsEditor');
    CKEDITOR.replace('termsConditionsEditor');
	</script>
