        ...
        <div id="accordion">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="agreement_number"><?php echo lang('Agreement Number');?> <span class="text-danger">*</span></label>
                  <input  type="text" class="form-control" placeholder="<?php echo lang('Agreement Number');?>" name="agreement_number"  id="agreement_number">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="location"><?php echo lang('location');?> <span class="text-danger">*</span></label>
                  <input type="url" class="form-control" placeholder="<?php echo lang('location');?>" name="location"  id="location">
                </div>
              </div>
              <div class="col-md-12">
