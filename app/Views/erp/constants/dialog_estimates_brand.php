...
$result = $ConstantsModel->where('constants_id', $category_id)->where('type','estimate_brand')->first();
?>

<div class="modal-header">
  <h5 class="modal-title">
    <?= lang('Dashboard.xin_edit_estimate_brand');?>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?= site_url("erp/types/estimates_brand_list") ?>",
							type : 'GET'
						},
