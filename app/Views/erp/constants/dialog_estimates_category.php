...
$result = $ConstantsModel->where('constants_id', $category_id)->where('type','estimate_category')->first();
?>

<div class="modal-header">
  <h5 class="modal-title">
    <?= lang('Dashboard.xin_edit_estimate_category');?>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?= site_url("erp/types/estimates_category_list") ?>",
							type : 'GET'
						},
