    ...
    <div class="row m-b-1 animated fadeInRight">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="card-body">
            <?php $attributes = array('name' => 'add_estimate_category', 'id' => 'xin-form', 'autocomplete' => 'off');?>
            <?php $hidden = array('user_id' => 0);?>
            <?= form_open('erp/types/add_estimate_category', $attributes, $hidden);?>
            <div class="form-group">
              <label for="name">
                <?= lang('Dashboard.xin_estimate_category');?>
                <span class="text-danger">*</span> </label>
              <input type="text" class="form-control" name="name" placeholder="<?= lang('Dashboard.xin_estimate_category');?>">
            </div>
          </div>
