  ...
  <div class="col-md-12">
    <div class="form-group">
      ...
      <select class="form-control" name="status" id="status" data-plugin="select_hrm" data-placeholder="<?php echo lang('Main.dashboard_xin_status');?>">
        ...
        <option value="2"><?php echo lang('Partially Paid');?></option>
      </select>
    </div>
  </div>

  <div class="col-md-12" id="partial-payment-amount" style="display: none;">
    <div class="form-group">
      <label for="amount"><?php echo lang('How much is paying?');?></label>
      <input type="number" class="form-control" name="partial_payment_amount" id="partial_payment_amount" placeholder="<?php echo lang('Enter amount');?>">
    </div>
  </div>
</div>
</div>
