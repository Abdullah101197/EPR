...
if($result['status'] == 0){
	...
	$status = '<span class="badge badge-light-warning">'.lang('Partially Paid').'</span>';
} else {
      ...
      <div>
        <div class="card" id="printTable">
          <div class="card-header">
            ...
            <a href="https://wa.me/<?= $ccontact_number; ?>?text=Hello, I would like to discuss the invoice details." target="_blank" class="collapsed btn btn-sm waves-effect waves-light btn-success m-0">
            Send Whatsapp.  
          </a> 
          ...
          <div class="card-body">
                ...
                <div class="invoice-box row">
                  <div class="col-sm-12">
                    <table class="table table-responsive invoice-table table-borderless">
                      <tbody>
                        <tr>
                          <td><a href="#!"><img class="img-fluid" width="171" height="30" src="<?= base_url();?>/public/uploads/logo/other/<?= $ci_erp_settings['other_logo'];?>" alt="<?= $inv_company_info['company_name'];?>"></a></td>
                        </tr>
                        <tr>
                          <td><?= $inv_company_info['company_name'];?></td>
                        </tr>
                        <tr>
                          <td><?= $inv_company_info['address_1'];?>
                            , <br>
                            <?= $inv_company_info['address_2'];?></td>
                        </tr>
                        <tr>
                          <td><a class="text-secondary" href="mailto:<?= $inv_company_info['email'];?>" target="_top">
                            <?= $inv_company_info['email'];?>
                            </a></td>
                        </tr>
                        <tr>
                          <td><?= $inv_company_info['contact_number'];?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <div class="col-sm-12">
                <table class="table table-responsive invoice-table invoice-total">
                  <tbody>
                    ...
                    <?php if (!is_null($result['partial_payment_amount'])): ?>

                    <tr class="text-info">
                      <td><hr />
                        <h5 class="text-warning m-r-10">
                          <?= lang('Partial Paid Amount');?>
                          :</h5></td>
                      <td><hr />
                        <h5 class="text-warning">
                          <?= number_to_currency($result['partial_payment_amount'],$xin_system['default_currency'],null,2);?>
                        </h5>
                      </td>
                    ...
                    <tr class="text-info">
                      <td><hr />
                        <h5 class="text-danger m-r-10">
                          <?= lang('Remaing Amount');?>
                          :</h5></td>
                      <td><hr />
                        <h5 class="text-danger">
                          <?= number_to_currency($result['grand_total']-$result['partial_payment_amount'],$xin_system['default_currency'],null,2);?>
                        </h5>
                      </td>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <?= htmlspecialchars_decode($item['bank_details']); ?>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <?= htmlspecialchars_decode($item['terms_conditions']); ?>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <?= htmlspecialchars_decode($item['invoice_footer']); ?>
