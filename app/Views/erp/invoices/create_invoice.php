...
<div class="row <?php echo $get_animate;?>">
  <div class="col-md-12">
    ...
    <div class="form-group">
        <label for="Clients">
            <?= lang('Clients'); ?> <span class="text-danger">*</span>
        </label>


        <select class="form-control" name="Client" id="clientSelect" data-plugin="select_hrm" data-placeholder="<?= lang('Clients'); ?>">
            <option value=""><?= lang('Select Client'); ?></option>
            <?php foreach ($projects as $project) { 
                $client = $UsersModel->find($project['client_id']); 
                if ($client) { ?>
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <select class="form-control" name="project" id="projectSelect" data-plugin="select_hrm" data-placeholder="<?= lang('Projects.xin_project'); ?>">
            <option value=""><?= lang('Select Project'); ?></option>
            <?php foreach($projects as $project) { ?>
              <option value="<?php echo $project['project_id']; ?>" data-client-id="<?php echo $project['client_id']; ?>" style="display: none;">
            ...
            <?php } ?>
                        ...
                        <div data-repeater-list="items">
                          <div data-repeater-item="">
                            <div class="row item-row">
                              ...
                              <label for="Item Discount Type	">
                                  <?= lang('Item Discount Type');?>
                                </label>
                                <select name="item_discount_type" class="form-control item_discount_type">
                                  <option value="1">
                              ...
                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                 ...
                                 <input style="text-align:right" type="text" name="item_discount_figure" class="form-control item_discount_figure" value="0" data-valid-num="required">
                              </div>
                ...
                <div class="col-md-12">
                <div class="form-group">
                  <label for="bank_details"><?php echo lang('Bank Details');?></label>
                  <textarea class="form-control editor" placeholder="<?php echo lang('Main.bank_details');?>" rows="5" name="bank_details">      
                </textarea>
                </div>
              </div>
                ...
                <div class="col-md-12">
                <div class="form-group">
                  <label for="terms_conditions"><?php echo lang('Terms Conditions');?></label>
                  <textarea class="form-control editor" placeholder="<?php echo lang('Main.terms_conditions');?>" rows="5" name="terms_conditions">      
                </textarea>
                </div>
              </div>

              <div class="col-md-12" id="invoice-footer">
                <div class="form-group">
                <label for="invoice_footer"><?php echo lang('Invoice Footer');?></label>
                  <textarea class="form-control editor" placeholder="<?php echo lang('Main.invoice_footer');?>" rows="5" name="invoice_footer">      
                </textarea>
                </div>
              </div>
