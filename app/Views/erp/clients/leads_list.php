...
$country_data = $CountryModel->findAll();
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="country" data-plugin="select_hrm" data-placeholder="<?= lang('Main.xin_employee_gender');?>">
                  <?php 
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control editor" placeholder="<?= lang('Inventory.xin_lead_details');?>" name="lead_description" cols="30" rows="2"></textarea>
                  </div>
              </div>
