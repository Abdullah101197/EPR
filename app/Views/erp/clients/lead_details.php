...
if($result['status'] == 1){
  ...
  $status = '<span class="badge badge-light-primary"><em class="icon ni ni-check-circle"></em> Client</span>';
	$status_label = '<i class="fas fa-certificate text-primary bg-icon"></i><i class="fas fa-check front-icon text-white"></i>';
}
?>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="gender" class="control-label">
                    <?= lang('Main.xin_source');?>
                  </label>
                  <select class="form-control" name="source" data-plugin="select_hrm" data-placeholder="<?= lang('Main.xin_source');?>">
                 
                       <option value="Digital" <?php if($result['source']=="Digital"):?> selected="selected"<?php endif;?>>
                         Digital
                      </option>
                       <option value="Sales" <?php if($result['source']=="Sales"):?> selected="selected"<?php endif;?>>
                         Sales
                      </option>
               ...
               <div class="col-md-4">
                 <div class="form-group">
                   ...
                   <select class="form-control" name="user_id" data-plugin="select_hrm" data-placeholder="Proposed To">
                   <?php 
                     foreach ($employees as $key => $employee) { ?>
                        <option value="<?= $employee['user_id'] ?>"  <?php if($employee['user_id']==$result['proposed_to']):?> selected="selected"<?php endif;?>>
                           <?= $employee['username'] ?>
                       </option>
                 <?php    }
                   ?>  
              ...
              <div class="form-group">
                ...
                <select disabled class="form-control" name="user_id" data-plugin="select_hrm" data-placeholder="Proposed To">

                      <option value="<?= $usession['sup_user_id'] ?>" value=""  selected="selected" >
                      <?= $user_info['username'] ?>
                    </option>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    <label for="lead_description">
                      <?= lang('Main.xin_lead_details');?>
                    </label>
                    <textarea class="form-control editor" placeholder="<?= lang('Inventory.xin_lead_details');?>" name="lead_description" cols="30" rows="2"><?= $result['lead_description'];?></textarea>
                  </div>
              </div>
              ...
              <table class="datatables-demo table table-striped table-bordered" id="xin_table" width="100%">
                <thead>
                  <tr>
                    ...
                    <th><?php echo lang('Main.xin_addedby');?></th>
