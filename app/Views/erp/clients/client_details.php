...
<div class="row">
  <div class="col-lg-4">
    <div class="card user-card user-card-1">
      ...
      <div class="nav flex-column nav-pills list-group list-group-flush list-pills" id="user-set-tab" role="tablist" aria-orientation="vertical"> <a class="nav-link list-group-item list-group-item-action active" id="user-basic-tab" data-toggle="pill" href="#user-edit-account" role="tab" aria-controls="user-edit-account" aria-selected="false"> <span class="f-w-500"><i class="feather icon-user m-r-10 h5 "></i>
        ...
        <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a> <a class="nav-link list-group-item list-group-item-action" id="user-estimates-tab" data-toggle="pill" href="#user-estimates" role="tab" aria-controls="user-estimates" aria-selected="false"> <span class="f-w-500"><i class="feather icon-calendar m-r-10 h5 "></i>
        Estimates
        </span>
        <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a> <a class="nav-link list-group-item list-group-item-action" id="user-projects-tab" data-toggle="pill" href="#user-projects" role="tab" aria-controls="user-projects" aria-selected="false"> <span class="f-w-500"><i class="feather icon-layers m-r-10 h5 "></i>
        <?= lang('Dashboard.left_projects');?>
        </span>
         <span class="float-right"><i class="feather icon-chevron-right"></i></span> </a> <a class="nav-link list-group-item list-group-item-action" id="user-tasks-tab" data-toggle="pill" href="#user-tasks" role="tab" aria-controls="user-tasks" aria-selected="false"> <span class="f-w-500"><i class="feather icon-edit m-r-10 h5 "></i>
  ...
  <div class="col-xl-8 col-lg-12">
    <div class="tab-content" id="pills-tabContent">
      ...
      <div class="tab-pane fade" id="user-estimates" role="tabpanel" aria-labelledby="user-estimates-tab">
...
<script>
  $(document).ready(function() {    
    var xin_estimates_table = $('#xin_estimates_table').DataTable({
        "bDestroy": true,
        "ajax": {
            url : main_url + "projects/client_profile_estimates_list?client_id=" + $('#client_id').val(),
            type : 'GET'
        },
        "columns": [
            { "data": "invoice_number" },
        ...
        "order": [[5, 'desc']], // Default sorting by 'created_at' column in descending order
        "language": {
