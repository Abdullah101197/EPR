        ...
        <div class="col-md-12">
          <div class="card" style="margin-top: 10px;">
              <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                      <h4 class="text-center">Approved By</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row pt-4">
                    <div class="col-md-12 text-center">
                      <p><strong>Email:</strong> <a href="mailto:info@alrawnaqicp.com">info@alrawnaqicp.com</a>, 
                          <strong>CR:</strong> 65278, 
                          <strong>Website:</strong> <a href="https://alrawnaqicp.com/">www.alrawnaqicp.com</a>, 
                          <strong>Post Box:</strong> 96525, 
                          <strong>Phone:</strong> <a href="tel:+9744444061">+974 4444 061</a>
                      </p>
