...
class Types extends BaseController {
	...
	public function estimates_category_list() {
		...
		$user_info = $UsersModel->where('user_id', $usession['sup_user_id'])->first();
		if($user_info['user_type'] == 'staff'){
			$category = $ConstantsModel->where('company_id',$user_info['company_id'])->where('type','estimate_category')->orderBy('constants_id', 'ASC')->findAll();
		} else {
			$category = $ConstantsModel->where('company_id',$usession['sup_user_id'])->where('type','estimate_category')->orderBy('constants_id', 'ASC')->findAll();
		}
		$data = array();
	...
	public function estimates_brand_list() {
		...
		$user_info = $UsersModel->where('user_id', $usession['sup_user_id'])->first();
		if($user_info['user_type'] == 'staff'){
			$category = $ConstantsModel->where('company_id',$user_info['company_id'])->where('type','estimate_brand')->orderBy('constants_id', 'ASC')->findAll();
		} else {
			$category = $ConstantsModel->where('company_id',$usession['sup_user_id'])->where('type','estimate_brand')->orderBy('constants_id', 'ASC')->findAll();
		}
		$data = array();
	...
	public function read_estimates_category()
	{
		$session = \Config\Services::session();
		$request = \Config\Services::request();
		if(!$session->has('sup_username')){ 
		...
		if($session->has('sup_username')){
			return view('erp/constants/dialog_estimates_category', $data);
		} else {
			return redirect()->to(site_url('erp/login'));
		}
	}
	public function read_estimates_brand()
	{
		$session = \Config\Services::session();
		$request = \Config\Services::request();
		if(!$session->has('sup_username')){ 
		...
		if($session->has('sup_username')){
			return view('erp/constants/dialog_estimates_brand', $data);
		} else {
			return redirect()->to(site_url('erp/login'));
		}
	}
	...
	public function add_estimate_category() {
	...
	public function add_estimate_brand() {
