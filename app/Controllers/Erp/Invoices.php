...
class Invoices extends BaseController {
	...
	{		
		var_dump('project_invoice_payment');
		die();
	...
	{		
		var_dump('client_invoice_payment');
		die();
	...
	public function pay_invoice_record() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$partial_payment_amount = $this->request->getPost('partial_payment_amount');
				...
				$data = [
					...
					'status'  => $status,
					'partial_payment_amount' => !is_null($partial_payment_amount) ? $partial_payment_amount : null
