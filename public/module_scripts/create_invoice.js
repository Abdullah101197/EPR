...
jQuery(document).on('change click','.item_discount_figure',function() {
	var tax_rate = 0;
	var discount_figure = $('.item_discount_figure').val();
	var discount_type = $('.item_discount_type').val(); 
	var qty = $(this).closest('.item-row').find('.qty_hrs').val();
	var unit_price = $(this).closest('.item-row').find('.unit_price').val();
   ...
   jQuery(this).closest('.item-row').find('.sub-total-item').val(grand_total); 
   jQuery(this).closest('.item-row').find('.sub-total-item').val(grand_total);
